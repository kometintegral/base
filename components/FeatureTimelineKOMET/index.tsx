...
import FeaturesTimelineItem from "./FeaturesTimelineItem";
import featuresTimelineData from "./featuresTimelineData";
...
const FeaturesTimeline = () => {
  ...
  return (
    <>
      {/* <!-- ===== Features Tab Start ===== --> */}
      <section className="relative pb-20 pt-18.5 lg:pb-22.5" id="timeline">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {featuresTimelineData.map((feature, key) => (
              <div
                className={feature.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <FeaturesTimelineItem featureTab={feature} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
